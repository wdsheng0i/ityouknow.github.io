---
layout: post
title: Nexus搭建maven私服、maven常见问题汇总（待梳理）
category: dev-ops
tags: [dev-ops]
---
...
<repositories> //私服仓库
    <repository>
    <id>1</id>
    <url>http://10.45.4.150:8081/nexus/content/groups/public</url>
    </repository>
</repositories>
```
...
```terminal执行命令：mvn dependency:tree -Dverbose -Dincludes=org.aspectj:aspectjweaver```
