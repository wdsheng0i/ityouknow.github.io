...
#### 架构演进
1.WEB1.0：静态网页访问  
![](../../assets/images/2021/mooc-arch/web1.0.png)

2.WEB1.0演进：有用户数据交互WEB  
![](../../assets/images/2021/mooc-arch/web1.1db.png)

3.单体架构-JAVAWEB：MVC，一台服务器即可，用户访问量少  
![](../../assets/images/2021/mooc-arch/mvc.png)

4.单体架构演进：拆分文件存储、DB独立服务器，3台服务器  
![](../../assets/images/2021/mooc-arch/file_server.png)

5.单体架构演进：引入缓存中间件，热点数据减少数据库压力  
![](../../assets/images/2021/mooc-arch/cache.png)

6.集群-负载均衡  
![](../../assets/images/2021/mooc-arch/cache_cluster.png)

7.DB主从-读写分离、主从同步  
![](../../assets/images/2021/mooc-arch/db-ms.png)

8.DB分库分表：分布式数据库（单表 达到800万即可考虑），分布式主键-全局唯一主键  
![](../../assets/images/2021/mooc-arch/db-ms-clu.png)

9.引入搜索引擎：满足检索需求  
![](../../assets/images/2021/mooc-arch/search.png)

10.微服务：拆分服务、分布式事务  
![](../../assets/images/2021/mooc-arch/ms.png)

11.分布式集群、公共服务组件、调优  
![](../../assets/images/2021/mooc-arch/fbs.png)

前后端分离模式  
![](../../assets/images/2021/mooc-arch/djfl.png)

技术栈  
![](../../assets/images/2021/mooc-arch/stickPicture.png)
