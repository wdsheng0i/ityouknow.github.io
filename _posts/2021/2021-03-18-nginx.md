...
![](../../assets/images/2021/nginx/worker.png)

### Nginx处理Web请求机制解析
处理web请求机制：异步非阻塞 epoll多路复用  
![](../../assets/images/2021/nginx/event.png)  
![](../../assets/images/2021/nginx/events.png)
...
```
### DNS域名解析 
![](../../assets/images/2021/nginx/dns.png)  
![](../../assets/images/2021/nginx/daili.png)
...
![](../../assets/images/2021/nginx/cor.png)  
允许跨域的方式
...
``` 
### 4-2 Nginx的模块化设计解析 
![](../../assets/images/2021/nginx/modue.png)  

### 4-3 Nginx的集群、反向代理、负载均衡解析
![](../../assets/images/2021/nginx/fuzaijunheng.png)  
Nginx主要功能就是通过upstream模块实现 “反向代理、 集群、 负载均衡、 路由分发控制”　   
- 当upstream只配置一个节点时，就只有反向代理的作用，没有集群就谈不上负载均衡了

### 4-6 四层、七层与DNS负载均衡　
![](../../assets/images/2021/nginx/dns-bla.png)  
...
![](../../assets/images/2021/nginx/hash.png)    

![](../../assets/images/2021/nginx/ip-hash2.png)  
...
![](../../assets/images/2021/nginx/ip-hash.png)  

**服务节点增减带来的问题**
- 如果节点数量变化，所有请求需要重新hash，原来的用户会话和缓存都会丢失  
![](../../assets/images/2021/nginx/hash-req.png)  

### 4-24 一致性hash算法　
只有增减节点影响到**服务节点环形**的就近节点，用户会话和缓存会发生变化，其他大部分节点用户不会变化
![](../../assets/images/2021/nginx/1-hash.png)   
![](../../assets/images/2021/nginx/1-hash-add.png)    
![](../../assets/images/2021/nginx/1-hash-l.png)  

### 4-25-26 负载均衡原理 - url hash 与 least_conn　
![](../../assets/images/2021/nginx/url-hash.png)    
```$xslt
...
![](../../assets/images/2021/nginx/nginx-cache.png)    
1.浏览器缓存：
...
![](../../assets/images/2021/nginx/fxdl.png)  
...
upstream api.shop.mooc.com{
    server 172.17.41.6:8088; //实际后端api服务集群节点1
    server 172.17.41.7:8088; //实际后端api服务集群节点2
}
...
![](../../assets/images/2021/nginx/cdn.png)    
![](../../assets/images/2021/nginx/nginx-djfl.png)    
1.服务器上创建前端静态资源项目目录：/home/website  
2.上传前端项目到website下  
3.nginx中配置静态资源代理  
4.修改前端js中api接口地址：修改为```api.shop.mooc.com:80; //80端口默认可以去掉``  
5.配置nginx代理静态资源  
```$xslt
# 修改nginx.cong服务器主机配置（虚拟主机、反向代理等）
    server {
