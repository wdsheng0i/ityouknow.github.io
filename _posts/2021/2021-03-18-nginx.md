...
## Nginx用途
Nginx是一个静态资源服务器，同时也是能实现反向代理、集群、负载均衡等功能的服务器
...
### 4-34 部署Nginx到云端 - 安装Nginx　

### 4-35 部署Nginx到云端 - 配置反向代理　

### 4-36 附：使用Nginx配置HTTPS域名证书 

### 4-37 部署Nginx到云端 - 实现动静分离与虚拟主机

### 4-38 部署Nginx到云端 - 测试与日志调试
